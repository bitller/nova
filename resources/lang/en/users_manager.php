...
return [
    ...
    'make_special_user' => 'Make special user',
    'make_special_user_info' => 'Special users can use Nova for free, without an active subscription or credit card details required',
