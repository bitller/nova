...
return [
    ...
    'click_here_to_see_how_to_add_a_product' => 'Click here to see how to add a product',
    'code' => 'Code',
    ...
    'empty_bill' => 'This bill has no products.',
    ...
    'more_details_about_unavailable_product' => 'More details about unavailable product',
    ...
    'payment_term_passed' => 'Payment term of this bill is passed!',
    ...
    'product_name_placeholder' => 'Example: Asier Watch',
    'product_not_available_info' => 'Check only when a product can not be shipped with the other products. The product will be highlighted and the client will know about this.',
    'product_not_exists_info' => 'Looks like this product does not exists. Please enter their name and then will be possible to use this product in all of your bills.',
    ...
    'this_product_is_not_available' => 'This product is not available and will be shipped next time',
    'tooltip' => 'This bill has been paid.',
    'to_pay' => 'To pay',
    'unavailable_products' => 'Unavailable products that will be shipped next time',
];