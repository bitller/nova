...
return [
    ...
    'client_does_not_have_paid_bills' => 'Acest client nu are facturi plătite.',
    'client_does_not_have_unpaid_bills' => 'Acest client nu are facturi neplătite.',
    ...
    'delete_client_tooltip' => 'Șterge clientul ales. Ține minte, toate facturile clientului vor fi șterse!',
    ...
    'email' => 'Email',
    'email_tooltip' => 'Email-ul clientului. Folosit pentru a trimite notificări despre starea comenzilor',
    ...
    'money_generated' => 'Acest client a făcut cumpărături în valoare de :money ron.',
    'money_generated_by_this_client' => 'Vânzări generate de acest client',
    'money_generated_by_this_client_in_this_year' => 'Vânzări generate de acest client în acest an',
    'money_generated_by_this_client_in_this_year_more_details' => 'Acest client a generat vânzări în valoare de :money ron în acest an.',
    ...
    'name' => 'Nume',
    'name_tooltip' => 'Numele clientului',
    ...
    'number_of_orders_tooltip' => 'Numărul de comenzi efectuare de client',
    'number_of_paid_bills' => 'Numărul de facturi plătite ale acestui client.',
    'number_of_products' => 'Numărul de produse',
    'number_of_products_ordered' => 'Numărul de produse comandate',
    'number_of_products_ordered_this_year' => 'Numărul de produse comandate în acest an',
    'number_of_products_sold' => 'Acest client a cumpărat de la tine în total :number produse.',
    'number_of_products_sold_this_year' => 'Acest client a cumpărat de la tine în acest an :number produse.',
    'number_of_unpaid_bills' => 'Numărul de facturi neplătite ale acestui client.',
    'only_paid_bills_are_included' => ' Ține minte, doar facturile marcate ca plătite sunt luate în considerare pentru aceste statistici.',
    ...
    'phone_number_tooltip' => 'Numărul de telefon al clientului. Folosit pentru a trimite notificări despre starea comenzilor',
