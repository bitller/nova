...
@section('content')
    ...
    <div id="bill" bill-id="{{ $billId }}" v-show="loaded">
        ...
        <div class="col-md-12">
            ...
            <div class="well well-sm custom-well col-md-3 text-center print-detail" v-show="bill.total">
            ...
            <div class="well well-sm custom-well col-md-2 text-center print-details" v-show="bill.total">
            ...
            <div class="well well-sm custom-well col-md-3 text-center print-details" v-show="bill.total">
