<!-- BEGIN Admin other details modal -->
<div id="admin-other-details-modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" v-on="click: editUserBillOtherDetails" v-attr="disabled : loading">
