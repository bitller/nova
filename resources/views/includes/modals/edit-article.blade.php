<!-- BEGIN Edit article modal modal -->
<div id="edit-article-modal" data-backdrop="static" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ trans('help_center.edit_article') }}</h4>
            </div>
            <!-- END Modal header -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" v-attr="disabled: loading" v-on="click: editArticle()">
                    <span v-show="loading" class="glyphicon glyphicon-refresh glyphicon-spin"></span>
                    <span v-show="!loading">{{ trans('help_center.edit_article') }}</span>
                </button>
            </div>
            <!-- END Modal footer -->
