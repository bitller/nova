    ...
    <div id="client-paid-bills" class="container" v-show="loaded" client-id="{{ $clientId }}">
        ...
        <div class="add-client-button">
            <span class="my-clients-title">
                <span>{{ trans('clients.paid_bills_of')}} {{ $name }} <span class="badge" data-toggle="tooltip" data-placement="right" title="{{ trans('clients.number_of_paid_bills') }}">{{ $totalPaidBills }}</span></span>
            </span>
        ...
        <div v-show="data.total > 0">
            <div class="panel panel-default">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr v-repeat="paid_bill in data.data">
...
@section('scripts')
    ...
    <script src="/js/client-paid-bills.js"></script>
@endsection