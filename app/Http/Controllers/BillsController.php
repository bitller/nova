...
class BillsController extends Controller {
    ...
    public function getBills() {
        ...
        $bills = Bill::select('bills.id', 'bills.campaign_order', 'bills.campaign_number', 'bills.campaign_year', 'bills.payment_term', 'bills.other_details', 'clients.name as client_name')
